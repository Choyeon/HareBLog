    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_title', models.CharField(help_text='页面标签的文本', max_length=20, verbose_name='页面标题')),
                ('color_theme', models.CharField(help_text='网站主题色', max_length=8, verbose_name='主题色')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.CharField(blank=True, help_text='如果不是HTML类型可为空', max_length=500, verbose_name='展示内容')),
